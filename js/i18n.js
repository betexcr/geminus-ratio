...
var I18n = (function () {
  ...
  var STRINGS = {
    en: {
      ...
      dialog: { ok: "OK", cancel: "Cancel", overwrite: "Overwrite" },
      ux: {
      ...
      controls: {
        ...
        b2: "Esc — cancel targeting or close ability menu. Keys 1–9 pick an ability when the menu is open.",
    ...
    es: {
      ...
      dialog: { ok: "Aceptar", cancel: "Cancelar", overwrite: "Sobrescribir" },
      ux: {
      ...
      controls: {
        ...
        b2: "Esc — cancelar selección o cerrar el menú. Teclas 1–9 eligen habilidad con el menú abierto.",
